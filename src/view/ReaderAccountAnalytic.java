 ...
 * @author admin
 */
public class ReaderAccountAnalytic extends javax.swing.JFrame {
    TaiKhoan acc;
    /**
     * Creates new form BookAnalytic
     */
    public ReaderAccountAnalytic() {
        initComponents();
    ...
    public ReaderAccountAnalytic(TaiKhoan taiKhoan) {
        initComponents();
        setLocationRelativeTo(null);
        Image img = new ImageIcon(this.getClass().getResource("/icon/library3.png")).getImage();
        this.setIconImage(img);
    ...
    private void btnInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInActionPerformed
        ...
        ArrayList<TaiKhoan> arr = taiKhoanDAO.getAccountDGArr();
        try {
            XSSFWorkbook workbook = new XSSFWorkbook();
            XSSFSheet sheet = workbook.createSheet("thongKeTaiKhoanDocGia");
            ...
            File f = new File("D:bangThongKeTaiKhoanDocGia.xlsx");
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReaderAccountAnalytic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReaderAccountAnalytic().setVisible(true);
            }
        });
    }
