...
public class AccountManage extends javax.swing.JFrame {
    ...
    public AccountManage(TaiKhoan taiKhoan) {
        initComponents();
        setLocationRelativeTo(null);
        Image img = new ImageIcon(this.getClass().getResource("/icon/library3.png")).getImage();
        this.setIconImage(img);
    ...
    public void showTable() {
        tableMain.removeAll();
        DefaultTableModel model = new TaiKhoanDAO().getAccountADTTList();
        tableMain.setModel(model);
    }
    
    public void showSoLuongTaiKhoan() {
        labelSoTaiKhoan.setText(new TaiKhoanDAO().getSoLuongTaiKhoanADTT()+ "");
    }
    ...
    private void initComponents() {
        ...
        comboVaiTro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "........", "Thủ thư", "Admin" }));
