 ...
 * @author admin
 */
public class SearchByPublisher extends javax.swing.JFrame {
    TaiKhoan acc;
    /**
     * Creates new form SearchByPublisher
     */
    ...
    public SearchByPublisher(TaiKhoan taiKhoan) {
        initComponents();
        setLocationRelativeTo(null);
        Image img = new ImageIcon(this.getClass().getResource("/icon/library3.png")).getImage();
        this.setIconImage(img);
    ...
    public void showTable(String nhaXuatBan) {
        tableMain.removeAll();
        DefaultTableModel model = new SachDAO().timKiemTheoNXB(nhaXuatBan);
    ...
    private void initComponents() {
        ...
        txtNXB.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jLabel1.setText("TÌM KIẾM THEO NXB");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtNXB, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        //sachDao.timKiemTheoNXB(nhaXuatBan);
        //JOptionPane.showMessageDialog(this, "Susccessful !");
        showTable(nhaXuatBan);
        txtNXB.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchByPublisher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
